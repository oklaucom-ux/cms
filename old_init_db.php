...
// ΓöÇΓöÇ Performance Indexes (critical for high-traffic) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
$indexes = [
    // Auth & Security
...
foreach ($indexes as $idx) {
    try { $pdo->exec($idx); } catch (Exception $e) { /* Index may already exist or column type mismatch ΓÇö skip */ }
}

// ΓöÇΓöÇ Schema Migrations (run once here, NOT on every page load) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
foreach ($migrations as $m) {
    try { $pdo->exec($m); } catch (Exception $e) { /* Column/table may already exist ΓÇö skip */ }
}
