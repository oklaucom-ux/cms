...
$announcements = [];
try {
    $pdo->exec("CREATE TABLE IF NOT EXISTS intranet_posts (id INTEGER PRIMARY KEY AUTO_INCREMENT, user_id TEXT NOT NULL, content TEXT NOT NULL, post_type TEXT DEFAULT 'General', created_at DATETIME DEFAULT CURRENT_TIMESTAMP)");
