...
// Auto-Migrate schema
try { $pdo->exec("ALTER TABLE assets ADD COLUMN branch_id TEXT DEFAULT 'Global HQ'"); } catch(Exception $e){}
$pdo->exec("CREATE TABLE IF NOT EXISTS assets (id INTEGER PRIMARY KEY AUTO_INCREMENT, asset_tag TEXT UNIQUE NOT NULL, name TEXT NOT NULL, type TEXT NOT NULL, assigned_to TEXT, branch_id TEXT DEFAULT 'Global HQ', status TEXT DEFAULT 'Unassigned', condition TEXT DEFAULT 'Good', registered_at DATETIME DEFAULT CURRENT_TIMESTAMP)");
