...
function openRoleModal(data = null) {
    ...
    const permGroups = {
        ...
        'Human Resources': ['view_hr_dashboard', 'view_onboarding', 'manage_onboarding', 'view_attendance', 'manage_attendance', 'view_leaves', 'approve_leaves', 'view_payroll', 'manage_payroll', 'manage_recruitment', 'manage_reviews', 'access_surveys', 'manage_surveys'],
