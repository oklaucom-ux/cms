...
function openRoleModal(data = null) {
    ...
    const permGroups = {
        'Core Modules': ['view_dashboard', 'access_executive_dashboard'],
        'User Administration': ['view_users', 'create_users', 'edit_users', 'delete_users', 'manage_users'],
        'Roles & Security': ['manage_roles', 'manage_settings', 'view_audit_trail', 'manage_broadcasts', 'send_broadcast_emails'],
        'Human Resources': ['view_hr_dashboard', 'view_onboarding', 'manage_onboarding', 'view_attendance', 'manage_attendance', 'access_employee_portal', 'view_leaves', 'approve_leaves', 'view_payroll', 'manage_payroll', 'manage_recruitment', 'manage_reviews', 'access_surveys', 'manage_surveys'],
        ...
        'Finance — Assets': ['view_assets', 'create_assets', 'edit_assets', 'delete_assets', 'manage_assets'],
        'Finance — Expenses': ['view_expenses', 'create_expenses', 'approve_expenses', 'delete_expenses', 'access_bank_reconciliation'],
        'Finance — Invoices': ['view_invoices', 'create_invoices', 'edit_invoices', 'delete_invoices', 'access_b2b_ledger'],
        'Finance — Procurement': ['manage_procurement', 'manage_vendors'],
        'Projects & Tasks': ['view_projects', 'create_projects', 'edit_projects', 'delete_projects', 'manage_projects', 'view_tasks', 'create_tasks', 'edit_tasks', 'delete_tasks'],
        'Activities & Calendar': ['view_activities', 'create_activities', 'edit_activities', 'delete_activities', 'view_calendar', 'access_calendar', 'view_meetings', 'create_meetings', 'view_reports'],
        ...
        'Contracts & Legal': ['view_contracts', 'create_contracts', 'edit_contracts', 'delete_contracts', 'manage_contracts'],
    ...
    const permLabels = {
        ...
        view_hr_dashboard: 'View HR Dashboard', view_onboarding: 'View Applicant Pipeline', manage_onboarding: 'Approve/Reject Applicants',
        ...
        view_visiting_cards: 'View Visiting Cards Library', scan_visiting_cards: 'Scan & OCR Cards', manage_visiting_cards: 'Manage Card Templates & Actions',
        view_campaigns: 'View Sales Campaigns', create_campaigns: 'Create & Edit Campaigns', execute_campaigns: 'Dispatch Campaign Outreach', manage_campaigns: 'Full Campaign & Drip Management',
        view_inventory: 'View Inventory Master Catalog', manage_inventory: 'Manage Stock Items & Batches', adjust_stock: 'Inward/Outward Stock Adjustments', access_pharmacy_pos: 'Access Pharmacy POS Counter',
