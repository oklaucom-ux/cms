...
// Tasks
if (($GLOBAL_SETTINGS['module_projects'] ?? 'true') !== 'false' && hasPermission($pdo, 'view_tasks')) {
    try {
...
// Projects
if (($GLOBAL_SETTINGS['module_projects'] ?? 'true') !== 'false' && hasPermission($pdo, 'view_projects')) {
    try {
...
// CRM Leads
if (($GLOBAL_SETTINGS['module_crm'] ?? 'true') !== 'false' && hasPermission($pdo, 'view_crm')) {
    try {
...
// Assets
if (($GLOBAL_SETTINGS['module_assets'] ?? 'true') !== 'false' && hasPermission($pdo, 'view_assets')) {
    try {
...
// Documents
if (hasPermission($pdo, 'view_documents')) {
    try {
