...
$pdo->exec("CREATE TABLE IF NOT EXISTS user_preferences (user_id TEXT PRIMARY KEY, theme VARCHAR(255) DEFAULT 'light', updated_at DATETIME DEFAULT CURRENT_TIMESTAMP)");
