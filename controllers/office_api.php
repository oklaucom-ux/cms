...
try { $pdo->exec("ALTER TABLE office_files ADD COLUMN locked_by TEXT DEFAULT NULL"); } catch(Exception $e){}
try { $pdo->exec("ALTER TABLE office_files ADD COLUMN approval_status TEXT DEFAULT 'Draft'"); } catch(Exception $e){}
try { $pdo->exec("ALTER TABLE office_files ADD COLUMN approved_by TEXT DEFAULT NULL"); } catch(Exception $e){}
